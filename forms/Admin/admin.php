<div style="border:solid" onclick="clickDiv('setting_user')" id="setting_a">
  Настройка пользователя(смена пороля) 
  </div>
  <div id="setting_user"  style="display:none">
    <form  method="post">
	<input id="password_update" type="text" maxlength="11" />
<input  type="button" height="50" align="center" name="update_pw" value="Сменить пароль " onclick="update_pw_fun('password_update')" />

    </form>
  </div>
<div onclick="clickDiv('list_admin')"  style="border:solid" id="list_a">
  Список пользователей 
  </div>
  <div id="list_admin" style="display:none" >
  <form  method="post">
<input  type="button" height="50" align="center" name="cr_data" value="&#1044;&#1086;&#1073;&#1072;&#1074;&#1080;&#1090;&#1100; &#1087;&#1086;&#1083;&#1100;&#1079;&#1086;&#1074;&#1072;&#1090;&#1077;&#1083;&#1103; " onclick="divindiv('menu_add_data2')" />
...
//echo $count_r[0].' '.$count_r[1].' '.$count_r[2].' '.$count_r[3].' '.$count_r[4].' '.$count_r[5].' '.$count_r[6].' '.$count_r[7];
  ...
  <div  id="menu_add_data2"  style="display:none"> 
  <? include("create_admin2.php"); ?>
  </div>
  <div id="report_a" style="border:solid" >
 Отчеты
  </div>
