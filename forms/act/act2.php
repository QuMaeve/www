<div id="rasp_tab" ><form   method="get">
<input  type="button" height="50" align="center" name="cr_rasp" value="&#1057;&#1086;&#1079;&#1076;&#1072;&#1090;&#1100; &#1085;&#1086;&#1074;&#1099;&#1081; &#1072;&#1082;&#1090; " onclick="f_obr_create()"  />
</form>
<?php if( isset( $_POST[$cr] ) ){echo "<p>"; include_once('forms\act\create_act.php');} echo'</p>' ?>  
<table width="100%" border="2" align="center" cellpadding="0" cellspacing="0" bgcolor=#FFFFFF id="obr_table">
<tr>
  <td width="4%" height="46" class="td_style_1"><div align="center"><strong>&#8470;&#1056;&#1072;&#1089;&#1087;&#1086;&#1088;&#1103;&#1078;&#1077;&#1085;&#1080;&#1103;</strong></div></td>
  <td width="14%" class="td_style_2"><div align="center"><b>&#1044;&#1072;&#1090;&#1072; &#1088;&#1072;&#1089;&#1087;&#1086;&#1088;&#1103;&#1078;&#1077;&#1085;&#1080;&#1103; </b></div></td>
<td width="13%" class="td_style_3"><div align="center"><b>&#1054;&#1089;&#1085;&#1086;&#1074;&#1072;&#1085;&#1080;&#1103;</b></div></td>
...
<td class="td_style_5"><select  name="find_id_violation"  class="button_style_1">
  '
	 <?php echo '<option value=""></option>';
      $q_obj=mysql_query ("SELECT Name_org, id FROM complaints_obj ");
				while ($r_obj = mysql_fetch_row($q_obj)) 
					{ if ($r_obj[0] == ""){}
						...
						echo '<option value="'.$r_obj[1].'"> '.$r_obj[0].'</option>';
							}
					}?>
</select></td>
