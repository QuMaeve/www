...
switch($depart){
case(1):
$text_in='INSERT INTO `act` (`act_year`, `num`, `date_act`, `id_order`, `address_id`, `obj_id`, `num_time`, `complaint_check`, `area`, `risc`, `risc_v`, `in_police`) VALUES ("'.$year.'", "'.$max_num.'", "'.$date_p.'", "'.$rasp_id.'", "'.$address_id.'", "'.$obj_id.'", "'.$num_time.'",  "'.$predpis.'", "'.$area.'", "'.$risc.'", "'.$risc_v.'", "'.$in_police.'");';
break;
case(2):
$text_in='INSERT INTO `act` (`act_year`, `num`, `date_act`, `id_order`, `address_id`, `obj_id`, `num_time`, `complaint_check`,  `in_police`, `size_recalculation`,  `recalculation_charge`) VALUES  ("'.$year.'", "'.$max_num.'", "'.$date_p.'", "'.$rasp_id.'", "'.$address_id.'", "'.$obj_id.'", "'.$num_time.'",  "'.$predpis.'", "'.$in_police.'", "'.size_recalculation.'",  "'.$recalculation_charge.'");';
break;
