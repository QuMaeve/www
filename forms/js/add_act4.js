...
function add_act() {
 ...
 if (document.getElementById("covid").checked){var covid="1";}else{var covid="";}
 //alert (covid);
                        ...
                        case (1):
                            if(pl_obj==""){alert("Указанны не все данные!!!");}else {
                                var val_data={u_id:u_id, depart:depart, date_p:date_p, rasp_id:choice_list, address_id:address_rasp
                                    ...
                                    , risc_v:risc_p, in_police:in_police, v_li:v_li, predpis:predpis, vv:vv, covid:covid};
                        ...
                        case (2):
                            if(Size_n==""){alert("Указанны не все данные!!!");}
                                ...
                                var val_data={u_id:u_id, depart:depart, date_p:date_p, rasp_id:choice_list, address_id:address_rasp
                                    ...
                                    , size_recalculation:Size_n, in_police:in_police, v_li:v_li, predpis:predpis, vv:vv, covid:covid};
                                add_act_fun(val_data);
                            }
                            break;
                    }
