...
FROM  `notify`
  ...
  where  `year_notify` ="'.$year.'" ORDER BY `notify`.`num` DESC ';
...
$pp='<tr><td>'.$r_obj[1].'</td><td> '.date('d.m.Y',strtotime($r_obj[2])).'</td><td>'.iconv("utf-8","windows-1251",$r_obj[4]).' '.date('d.m.Y',strtotime($r_obj[3])).'</td><td></td><td><input   type="button" name="tab_button_U_protocol" value="&#1055;&#1088;&#1086;&#1089;&#1084;&#1086;&#1090;&#1088;"  onclick="show_view('."'U_protocol', ".$r_obj[0].')" /></td></tr>';
