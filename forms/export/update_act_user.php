...
$text2="SELECT `id`, `id_workers`, `id_order` FROM `link_order_workers` WHERE  `id_order`  =".$r1[0];
echo '<p>'.$text2.'</p>';
...
$insert_tab=mysql_query ('INSERT INTO `link_act_workes`( `id_act`, `id_user`) VALUES ('.$r1[1].','.$r2[1].')');
