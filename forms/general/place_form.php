    ...
    <tr>
        <td>
            <form name="form1" id="form1">
                ...
                <input type="text" name="referal" id="find_obj_cell" width="200" autocomplete="off"
                       onkeyup=" findObj()">
                ...
                <p>&#1053;&#1072;&#1089;&#1077;&#1083;&#1077;&#1085;&#1085;&#1099;&#1081; &#1087;&#1091;&#1085;&#1082;&#1090;
                    <input type="text" name="find_city" id="find_city" width="200" autocomplete="off"
                           onkeyup=" findcity()"> <select name="l_city" id="l_city"
                                                          onchange="changeV('address',this.options[this.selectedIndex].value)">
                ...
                <div id="address" style="display:none">
                    &#1059;&#1083;&#1080;&#1094;&#1072;
                    <input type="text" name="referal" id="find_street" width="200" autocomplete="off"
                           onkeyup=" findstreet($('#l_city').value)"><select name="l_street" id="l_street">
                    </select>
                ...
                <p>&#1058;&#1080;&#1087; &#1085;&#1072;&#1088;&#1091;&#1096;&#1077;&#1085;&#1080;&#1103;
                    <select name="t_v" id="t_v"
                            onchange="changeVviolation('o_v_v','v_v',this.options[this.selectedIndex].value)">
                        <?
                ...
                <p id="o_v_v" style="display:none">&#1054;&#1073;&#1098;&#1077;&#1082;&#1090; &#1085;&#1072;&#1088;&#1091;&#1096;&#1077;&#1085;&#1080;&#1103;
                    ...
                    <select name="o_v" id="o_v"
                            onchange="changeV('v_v',this.options[this.selectedIndex].value); addSelviolation(this.options[this.selectedIndex].value);">
                    </select>
                </p>
                ...
                <p>
                    <input type="button" name="add_option_obr"
                           value="&#1044;&#1086;&#1073;&#1072;&#1074;&#1080;&#1090;&#1100;"
                           onclick="<? echo $_POST['fun']; ?>"/>
                </p>
            </form>
        </td>
        <td>
            <div name="tab_op_obr" id="t_o_o">
