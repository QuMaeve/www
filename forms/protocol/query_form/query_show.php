...
left join `article` on `article`.`id_article`=`protocol`.`article` WHERE `year_protocol` ="'.$year.'" ORDER BY `num` DESC ';
...
$span=$span.'<input name="page_'.$x.'" align="center"  type="button" value="'.$x.'" onclick="page_length_fun('."'".$x."'".", 'protocol'".')"/>';
}
...
$pp='<tr><td>'.$r_obj[1].'</td><td> '.date('d.m.Y',strtotime($r_obj[2])).'</td><td>'.iconv("utf-8","windows-1251",$r_obj[3]).'</td><td>'.iconv("utf-8","windows-1251",$r_obj[4]).'</td><td><input   type="button" name="tab_button_protocol" value="&#1055;&#1088;&#1086;&#1089;&#1084;&#1086;&#1090;&#1088;"  onclick="show_view('."'protocol', ".$r_obj[0].')" /></td></tr>';
...
echo $span;		
echo '<p><input value="&#1060;&#1080;&#1083;&#1100;&#1090;&#1088;" id="Filtr_protocol"  onclick="filtr_protocol_protocol()" type="button"/></p>' ;
include("filrt_protocol.php"); 
echo '<table width="100%"  border="2" align="center" cellpadding="0" cellspacing="0" bgcolor=#FFFFFF id="protocol_table">
<td  height="46" class="td_style_1"><div align="center"><strong>&#8470;</strong></div></td>
<td class="td_style_2"><div align="center"><strong>&#1044;&#1072;&#1090;&#1072;
 </strong></div></td>
<td  class="td_style_4"><div align="center"><b>&#1057;&#1090;&#1072;&#1090;&#1100;&#1103;
</b></div></td>
<td class="td_style_5"><div align="center"><b>&#1044;&#1086;&#1087;&#1086;&#1083;&#1085;&#1080;&#1090;&#1077;&#1083;&#1100;&#1085;&#1086; </b></div></td>
