...
include_once("..\link\link.php");
		if (!mysql_query('SELECT * FROM obr_obj_id'.$user_id.'_user')){
			mysql_query('create table IF NOT EXISTS obr_obj_id'.$user_id.'_user (
		...
		from obr_obj_id'.$user_id.'_user  where `id_obj` =  "'.$obj.'" and `id_city`=  "'.$city.'
