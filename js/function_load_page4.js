...
function f_U_pred_create() {
    ...
    if (document.getElementsByName('rasp_id_u').value !== "") {
...
function butt_up(path, val, id) {
    ...
    for (var i = 0; i < class_n.length; i++) {
        class_n.item(i).value = name;
    }
...
function filtr_fun(name) {
    ...
    if (document.getElementById("filtr_div_" + name).style.display == "block") {
        ...
        document.getElementById("filtr_div_" + name).style.display = "block";
    }
}
...
function page_length_fun_filter(val, path) {
    switch (path) {
        case ('predpis_old'):
            ...
            var data = {
                col_end: val, num_filter: num_filter,
...
function filer_add_form(name, val_p) {
    ...
    if (l_city == 0) {
        ...
        var find_city = $('#l_city_f option:selected').text();
    }
    ...
    if (l_street == 0) {
        ...
        var find_street = $('#l_street_f option:selected').text();
    }
    ...
    if (l_v == 0) {
        ...
        var v = $('#v_f option:selected').text();
    }
    ...
    if (l_u == 0) {
        ...
        var u = $('#user_f option:selected').text();
    }
